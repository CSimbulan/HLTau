...
fig1 = p.figure()
fig1.suptitle("Orbital Element Distributions For 5 Planet Systems")
...
fig2 = p.figure()
fig2.suptitle("Cumulative Eccentricity Distribution for 5 Planet Systems")
...
countsa, binsa, patchesa = ax4.hist(res4.e_samp, bins = 10000, histtype = "step", normed = 1, cumulative = True, visible = False)
countso, binso, patcheso = ax4.hist(eo, bins = 10000,histtype = "step", normed = 1, cumulative = True, visible = False)
#ax4.plot(bins[:-1], counts, 'b', label = "Resonant Final")
ax4.plot(binsa[:-1], countsa, 'b', label = "Resonant")
#counts, bins, patches = ax4.hist(nonres4.e_avg, histtype = "step", normed = 1, cumulative = True, visible = False)
countsa, binsa, patchesa = ax4.hist(nonres4.e_samp, bins = 10000,histtype = "step", normed = 1, cumulative = True, visible = False)
#ax4.plot(bins[:-1], counts, 'r', label = "Non-Resonant Final")
ax4.plot(binsa[:-1], countsa, 'r', label = "Non-Resonant")
...
fig3.suptitle("Eccentricity Distribution Comparison for 5 Planet Systems")
...
D, Pvalue = st.ks_2samp(res4.e_samp, nonres4.e_samp)
...
print "--------"*11
print "5P Resonant Final \t| {0}% \t| {1}% \t| {2}% \t| {3}%".format(pvrf, pvrf1, pvrf2, pvrf5)
print "5P Resonant Averaged \t| {0}% \t| {1}% \t| {2}% \t| {3}%".format(pvra, pvra1, pvra2, pvra5)
print "5P Non-Resonant Final \t| {0}% \t| {1}% \t| {2}% \t| {3}%".format(pvnf, pvnf1, pvnf2, pvnf5)
print "5P Non-Resonant Averaged| {0}% \t| {1}% \t| {2}% \t| {3}%".format(pvna, pvna1, pvna2, pvna5)
...
p.plot(res4.pa5, res4.pe5, color = colors[4], marker = "o", linestyle = "None",  label = "Resonant Planet 5 Results")
...
p.plot(nonres4.pa5, nonres4.pe5, color = colors[4], marker = "*", linestyle = "None", markersize = 10, label = "Non-Resonant Planet 5 Results")
...
fig5 = p.figure()
p.title("Cummulative Eccentriciy Distribution By Planet (5 Planet Systems)")
...
counts5, bins5, patches5 = ax9.hist(res4.pe5, 100, histtype = "step", normed = 1, cumulative = True, visible = False)
...
countsn5, binsn5, patchesn5 = ax9.hist(nonres4.pe5, 100, histtype = "step", normed = 1, cumulative = True, visible = False)
...
ax9.plot(bins5[:-1], counts5, color = colors[4], label = "Res P5")
...
ax9.plot(binsn5[:-1], countsn5, color = colors[4], linestyle = "--", label = "Non-Res P5")
...
D5, P5 = st.ks_2samp(counts5, countso)
...
print "5P Res Planet 1 Final \t| {0}% \t| \t \t| \t \t| \t".format(pvp1)
print "5P Res Planet 2 Final \t| {0}% \t| \t \t| \t \t| \t".format(pvp2)
print "5P Res Planet 3 Final \t| {0}% \t| \t \t| \t \t| \t".format(pvp3)
print "5P Res Planet 4 Final \t| {0}% \t| \t \t| \t \t| \t".format(pvp4)
print "5P Res Planet 5 Final \t| {0}% \t| \t \t| \t \t| \t".format(pvp5)
...
D5, P5 = st.ks_2samp(countsn5, countso)
...
print "5P NonRes Planet 1 Final| {0}% \t| \t \t| \t \t| \t".format(pvp1)
print "5P NonRes Planet 2 Final| {0}% \t| \t \t| \t \t| \t".format(pvp2)
print "5P NonRes Planet 3 Final| {0}% \t| \t \t| \t \t| \t".format(pvp3)
print "5P NonRes Planet 4 Final| {0}% \t| \t \t| \t \t| \t".format(pvp4)
print "5P NonRes Planet 5 Final| {0}% \t| \t \t| \t \t| \t".format(pvp5)
...
bars = ax10.bar([0.6, 1.6, 2.6, 3.6, 4.6], [len(res4.pa1), len(res4.pa2), len(res4.pa3), len(res4.pa4), len(res4.pa5)], edgecolor = "k")
...
ax10.set_xlim(0.5, 5.5)
ax10.set_ylim(0, 100)
ax10.grid()

ax11 = fig6.add_subplot(2,1,2)
ax11.set_title("Non-Resonant Case")
bars = ax11.bar([0.6, 1.6, 2.6, 3.6, 4.6], [len(nonres4.pa1), len(nonres4.pa2), len(nonres4.pa3), len(nonres4.pa4), len(nonres4.pa5)])
